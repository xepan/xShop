...
class View_Tools_Designer extends \componentBase\View_Component{
	...
	function render(){
		...
		$this->js(true)->xepan_xshopdesigner(array('width'=>91,'height'=>55,'trim'=>5,'unit'=>'mm','design'=>array(array('type'=>'Text','text'=>'hello'),array('type'=>'Bacground','url'=>'path.jgp','crop'=>array(1,2,3,4)))));
		parent::render();
	}
